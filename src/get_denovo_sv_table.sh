...
stix_sgdp=( $(cat denovo/denovo.stix_sgdp_stats | cut -f 2 | paste -sd ' ' -) )
stix_1kg=( $(cat denovo/denovo.stix_1kg_stats | cut -f 2 | paste -sd ' ' -) )
stix_1kg_sgdp=( $(cat denovo/denovo.stix_1kg_sgdp_stats | cut -f 2 | paste -sd ' ' -) )

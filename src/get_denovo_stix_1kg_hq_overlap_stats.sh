...
in_1kg_del=$( cat denovo/dnsv.GRCh37.DEL.bed.stix_1kg | awk '$6>2' | cut -f 1,2,3 | sort -u | wc -l )
denovo_dup=$( cat denovo/dnsv.GRCh37.DUP.bed.stix_1kg | cut -f 1,2,3 | sort -u | wc -l )
in_1kg_dup=$( cat denovo/dnsv.GRCh37.DUP.bed.stix_1kg | awk '$6>2' | cut -f 1,2,3 | sort -u | wc -l )
denovo_inv=$( cat denovo/dnsv.GRCh37.INV.bed.stix_1kg | cut -f 1,2,3 | sort -u | wc -l )
in_1kg_inv=$( cat denovo/dnsv.GRCh37.INV.bed.stix_1kg | awk '$6>2' | cut -f 1,2,3 | sort -u | wc -l )
